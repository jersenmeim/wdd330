import { getfromLS, writeToLS, qs} from "./ls.js";
...
class Hike {
  ...
  renderHike() {
    ...
    //adding click function in li element
    item.addEventListener('click', () => {
      ...
      //adding function to the submit and close button
      ...
      //append everthing until to the body
